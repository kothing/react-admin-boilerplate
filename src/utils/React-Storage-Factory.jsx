 ...
 * https://github.com/kothing/react-storage-factory/blob/master/README.md
 */
...
class StoreInterface {
    ...
    */
    ...
    setState() {
        console.warn(`[React State Management] Store ${this.name} uses a reducer to handle its state updates. use dispatch instead of setState`)
    }

    dispatch() {
        console.warn(`[React State Management Base on Hook] Store ${this.name} does not use a reducer to handle state updates. use setState instead of dispatch`)
    }
}
