...
const Example2 = () => {
    ...
    function TodoList() {
        ...
        return (
            <>
                <h2>TODOLIST</h2>
                <Form name='todolist' onFinish={onFinish} onFinishFailed={onFinishFailed} layout='inline' form={form}>
                    <Form.Item
                        label='Todo'
                        name='todo'
                ...
                <ul>
                    {state.todos.map(todo => (
                        <li key={todo.id}>
                            ...
                            <button onClick={() => deleteTodo(todo.id)} type='button' style={{ cursor: 'pointer' }}>
                                X
                            </button>
                        </li>
                    ))}
