...
import { LeftOutlined, RightOutlined, SearchOutlined, CloudOutlined, CloudDownloadOutlined, PoweroffOutlined } from '@ant-design/icons';
...
const ButtonView = () => {
    ...
    return (
        <Layout className='button animated fadeIn'>
            <div>
                <WebBreadcrumb arr={['通用', '按钮']}></WebBreadcrumb>
            </div>
